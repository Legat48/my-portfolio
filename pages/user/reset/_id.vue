<template>
  <div v-if="!$store.getters.getLoading" style="width: 100%;" class="content">
    <PasswordReset :id-url="idFromURL" class="content__wrap" :modal="false" />
...
export default {
  ...
  data () {
    return {
      idFromURL: null // Здесь будет храниться значение из URL
    }
  },
  created () {
    // При создании компонента получаем значение кода из URL и сохраняем его в переменную idFromURL
